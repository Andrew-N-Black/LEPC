...
path_to_directory = "/scratch/bell/blackan/LEPC/shotgun/angsd_out_filtered/bcf/"

#Estimate ROH based on "PL"
roh_input = path_to_directory  + sample
roh_output = path_to_directory + "_PL.txt"
ref_index_file = "/scratch/bell/blackan/LEPC/assembly/next/01_rundir/filtered/purged_scaf_trim_blob.fa.fai"
